...
const InputPasswordModalComponent = ({ placeholderTitle, icon, onChangeText, customWidthRatio = 0.8, value,
  placeholderColor,
  disabled = false,
  borderColor = '#B1C5D5',
  ...
  useEffect(() => {
    ...
    setFinalWidth(Math.floor(width * customWidthRatio > 400 ? 400 : width * customWidthRatio));
  }, [width, height])
...
export default InputPasswordModalComponent;
