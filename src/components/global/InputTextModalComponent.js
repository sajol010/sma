    ...
    <View>
      {isView && (
        <Neomorph
          ...
          style={{
            ...styles.container,
            width: width * widthRatio > 400 ? 400 : width * widthRatio,
        ...
        >
          <View style={{ ...styles.viewHoolder, width: width * widthRatio, maxWidth: 300, }}>
              ...
              <View style={{
                ...
                <TextInput
                  ...
                  style={{
                    ...
                    flexGrow: isFocus ? textLength > 1 ? 0.5 : 0 : 1,
...
export default InputTextModalComponent;
